...
public class BanqueWSLocator extends org.apache.axis.client.Service implements webservice.BanqueWS {
    ...
    public webservice.BanqueService getBanqueServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webservice.BanqueServicePortBindingStub _stub = new webservice.BanqueServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webservice.BanqueService.class.isAssignableFrom(serviceEndpointInterface)) {
                webservice.BanqueServicePortBindingStub _stub = new webservice.BanqueServicePortBindingStub(new java.net.URL(BanqueServicePort_address), this);
                _stub.setPortName(getBanqueServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice/", "BanqueWS");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice/", "BanqueServicePort"));
        }
